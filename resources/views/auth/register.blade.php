    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="country" class="col-md-4 col-form-label text-md-end">{{ __('Role') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" autocomplete="address" autofocus>{{ old('address') }}</textarea>
                        ...
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label text-md-end">{{ __('Hobby') }}</label>

                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hobbies[]" id="hobby1" value="hobby1">
                                    <label class="form-check-label" for="hobby1">
                                        Hobby 1
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hobbies[]" id="hobby2" value="hobby2">
                                    <label class="form-check-label" for="hobby2">
                                        Hobby 2
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hobbies[]" id="hobby3" value="hobby3">
                                    <label class="form-check-label" for="hobby3">
                                        Hobby 3
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hobbies[]" id="hobby4" value="hobby4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="profile" type="file" class="form-control @error('profile') is-invalid @enderror" name="profile" autofocus>
